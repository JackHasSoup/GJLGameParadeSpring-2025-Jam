...
EditorScene::EditorScene(sf::RenderTarget *hwnd) : Scene(hwnd)
{
	...
	//for save load
	commander.addPressed(sf::Keyboard::RBracket, new GenericCommand([=] { saveToFile("levels/jelly3.json"); }));
	commander.addPressed(sf::Keyboard::LBracket, new GenericCommand([=] { loadFromFile("levels/jelly3.json"); }));
	//for scroll

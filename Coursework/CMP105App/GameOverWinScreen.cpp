...
GameOverWinScreen::GameOverWinScreen(sf::RenderTarget* hwnd, sf::RenderWindow* screenHwnd) : UIScene(hwnd)
{
	...
	buttons[ButtonIndex::Play] = Button(midWin, winSize * 0.125f, 36, font, "Play Again", true);
	...
	buttons[ButtonIndex::Menu] = Button(midWin + sf::Vector2f{ 0,winSize.y * 0.15f }, winSize * 0.125f, 36, font, "Menu", true);
	...
	buttons[ButtonIndex::Exit] = Button(midWin + sf::Vector2f{ 0,winSize.y * 0.3f }, winSize * 0.125f, 36, font, "Exit", true);
...
void GameOverWinScreen::handleInput(float dt)
{
